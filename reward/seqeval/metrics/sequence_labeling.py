...
from reward.seqeval.metrics.v1 import SCORES, _precision_recall_fscore_support
from reward.seqeval.metrics.v1 import classification_report as cr
from reward.seqeval.metrics.v1 import \
    precision_recall_fscore_support as precision_recall_fscore_support_v1
from reward.seqeval.reporters import DictReporter, StringReporter
from reward.seqeval.scheme import Token
...
def precision_recall_fscore_support(y_true: List[List[str]],
    ...
    Examples:
        >>> from reward.seqeval import precision_recall_fscore_support
...
def get_entities(seq, suffix=False):
    ...
    Example:
        >>> from reward.seqeval import get_entities
...
def f1_score(y_true: List[List[str]], y_pred: List[List[str]],
    ...
    Example:
        >>> from reward.seqeval import f1_score
...
def accuracy_score(y_true, y_pred):
    ...
    Example:
        >>> from reward.seqeval import accuracy_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def precision_score(y_true: List[List[str]], y_pred: List[List[str]],
    ...
    Example:
        >>> from reward.seqeval import precision_score
        >>> y_true = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'O', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def recall_score(y_true: List[List[str]], y_pred: List[List[str]],
    ...
    Example:
        >>> from reward.seqeval import recall_score
        >>> y_true = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'O', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def performance_measure(y_true, y_pred):
    ...
    Example:
        >>> from reward.seqeval import performance_measure
...
def classification_report(y_true, y_pred,
    ...
    Examples:
        >>> from reward.seqeval import classification_report
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
